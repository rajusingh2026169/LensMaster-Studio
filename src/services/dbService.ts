...
export const dbServiceCategories = {
  ...
  seedDefaults: async (studioId: string) => {
    const defaultCategories: Omit<ServiceCategory, 'id' | 'createdAt'>[] = [
      { name: 'Video', status: 'Active', description: 'Drone, cinematography, traditional video & highlights', displayOrder: 1 },
      { name: 'Photograph', status: 'Active', description: 'Portrait, passport, studio photoshoot & albums', displayOrder: 2 },
      { name: 'Printing Press', status: 'Active', description: 'Flex, banners, mugs, photo frames & cards', displayOrder: 3 },
      { name: 'Album Design', status: 'Active', description: 'Canvera/Velvet custom photobooks & acrylic prints', displayOrder: 4 },
    ];
...
export const dbStudioServices = {
  ...
  seedDefaults: async (studioId: string) => {
    ...
    const defaultServices: Omit<StudioService, 'id' | 'createdAt' | 'updatedAt'>[] = [
      ...
      {
        serialNo: '000004',
        name: 'Traditional Video Full HD',
        categoryId: 'cat_video',
        categoryName: 'Video',
        investCost: 8000,
        sellingCost: 9000,
      ...
      {
        serialNo: '000005',
        name: 'Passport size photo (10 qty)',
        categoryId: 'cat_photo',
        categoryName: 'Photograph',
        investCost: 50,
        sellingCost: 70,
        taxRate: 18,
        basePrice: 70,
      ...
      {
        serialNo: '000006',
        name: 'Passport size photo (50 qty)',
        categoryId: 'cat_photo',
        categoryName: 'Photograph',
        investCost: 70,
        sellingCost: 100,
      ...
      {
        serialNo: '000007',
        name: 'Photograph Album size (15 × 30)',
        categoryId: 'cat_photo',
        categoryName: 'Photograph',
        investCost: 450,
        sellingCost: 700,
      ...
      {
        serialNo: '000008',
        name: 'Photograph Album size (15 × 36)',
        categoryId: 'cat_photo',
        categoryName: 'Photograph',
        investCost: 5000,
        sellingCost: 6000,
